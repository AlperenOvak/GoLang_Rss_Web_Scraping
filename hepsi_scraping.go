...
func main(){
	...
	c := colly.NewCollector(colly.AllowedDomains("www.hepsiburada.com"))
	...
	c.OnHTML(".moria-search-results", func(h*colly.HTMLElement){
		fmt.Println(count)
			/*h.ForEach("li.productListContent-zAP0Y5msy8OHn5z7T_K_", func(_ int, h*colly.HTMLElement){
					/*var name string
	...
	c.Visit("https://www.hepsiburada.com/ara?q=keyboard")
}
